...
variable "handler" {
  type        = string
  default     = "accounts-statistics-tool"
...
variable "release_bucket_name" {
  type        = string
  default     = "development-eu-west-2.release.ch.gov.uk"
...
variable "service" {
  type        = string
  default     = "innovation-accounts-statistics-tool"
  description = "The name of the service being deployed."
}

variable "binary-name" {
  type        = string
  default     = "accounts-statistics-tool"
  description = "The name of the packaged binary."
}
